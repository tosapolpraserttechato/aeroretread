...
export default function Dashboard() {
  ...
  return (
    <div className="p-6 bg-slate-950 min-h-screen font-sans text-slate-100">
                            ...
                            <td key={header} className="py-3 px-4 font-mono text-slate-355">
                              {isStatField ? (
                                ...
                                <button
                                  ...
                                  title="Click to track movement for this tire below"
                                >
      ...
      {dailyLogs.length > 0 && (
        <div ref={trackerRef} className="mt-8 bg-slate-900/90 rounded-2xl border border-slate-800 shadow-xl overflow-hidden mb-8 animate-fade-in">
